        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ZoneSlots_WarehouseZones_ZoneId",
                        column: x => x.ZoneId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ZoneSlotId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pallets_ZoneSlots_ZoneSlotId",
                        column: x => x.ZoneSlotId,
                        principalTable: "ZoneSlots",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pallets_ZoneSlotId",
                table: "Pallets",
                column: "ZoneSlotId",
                unique: true,
                filter: "[ZoneSlotId] IS NOT NULL");
